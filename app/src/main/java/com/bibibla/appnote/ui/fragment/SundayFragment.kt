...
import com.bibibla.appnote.databinding.FragmentSundayBinding
...
class SundayFragment(application: Application,private val activityContext: Context): Fragment(R.layout.fragment_sunday) , ItemClickListenerNote {
